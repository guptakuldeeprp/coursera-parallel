 ...
 */
public final class ReciprocalArraySum2 {

    /**
     * Default constructor.
     */
    private ReciprocalArraySum2() {
    }
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        ReciprocalArraySumTask(final int setStartIndexInclusive,
            ...
            this(setStartIndexInclusive, setEndIndexExclusive, setInput, 2, false);
        }
         ...
         */
        ReciprocalArraySumTask(final int setStartIndexInclusive,
                               final int setEndIndexExclusive, final double[] setInput, int setNumTasks, boolean seq) {
...
//                value = left.value + right.value;
                value =
                        invokeAll(getSubTasks())
                                .stream()
                                .mapToDouble(task -> task.getValue())
                                .sum();
...
//            System.out.println(getChunkSize(numTasks, input.length));
            for (int i = 0; i < numTasks; i++) {
                int _startIndexInclusive = getChunkStartInclusive(i, numTasks, input.length);
                int _endIndexExclusive = getChunkEndExclusive(i, numTasks, input.length);
//                System.out.println("_startIndexInclusive: " + _startIndexInclusive + ", _endIndexExclusive: " + _endIndexExclusive);
                ReciprocalArraySumTask task = new ReciprocalArraySumTask(_startIndexInclusive, _endIndexExclusive, input, numTasks, true);
                tasks.add(task);
            }
//            System.out.println("tasks size: " + tasks.size());
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        long startTime = System.nanoTime();
        ReciprocalArraySumTask task = new ReciprocalArraySumTask(0, input.length, input, numTasks, false);
        pool.invoke(task);
        long endTime = System.nanoTime();
